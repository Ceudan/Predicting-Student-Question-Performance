...
Due to time constraints we were unable to implement all features listed in this article. After the contest was over we fixed mistakes and updated our model to its current version, with the hypothetical rank shown below.
